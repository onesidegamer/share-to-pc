        ...
        implements SnackbarSupport, Activity.OnPreloadArgumentWatcher, WorkerService.OnAttachListener
{
    ...
    public static final String ACTION_SEND = "onesidegamer .intent.action.raitshare_SEND";
    public static final String ACTION_SEND_MULTIPLE = "onesidegamer .intent.action.raitshare_SEND_MULTIPLE";
