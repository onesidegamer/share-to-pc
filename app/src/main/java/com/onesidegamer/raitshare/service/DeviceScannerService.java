...
{
    public static final String ACTION_SCAN_DEVICES = "onesidegamer.intent.action.SCAN_DEVICES";
    public static final String ACTION_SCAN_STARTED = "onesidegamer.intent.action.SCAN_STARTED";
    public static final String ACTION_DEVICE_SCAN_COMPLETED = "onesidegamer.intent.action.DEVICE_SCAN_COMPLETED";

    public static final String EXTRA_SCAN_STATUS = "onesidegamer.intent.extra.SCAN_STATUS";

    public static final String STATUS_OK = "onesidegamer.intent.status.OK";
    public static final String STATUS_NO_NETWORK_INTERFACE = "onesidegamer.intent.status.NO_NETWORK_INTERFACE";
    public static final String SCANNER_NOT_AVAILABLE = "onesidegamer.intent.status.SCANNER_NOT_AVAILABLE";
