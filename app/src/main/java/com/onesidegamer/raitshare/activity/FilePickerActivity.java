...
{
    public static final String ACTION_CHOOSE_DIRECTORY = "com.onesidegamer.intent.action.CHOOSE_DIRECTORY";
    public static final String ACTION_CHOOSE_FILE = "com.onesidegamer.intent.action.CHOOSE_FILE";
