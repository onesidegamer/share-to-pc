...
public class WorkerService extends Service
{
    ...
    public static final String ACTION_KILL_SIGNAL = "com.onesidegamer.intent.action.KILL_SIGNAL";
    public static final String ACTION_KILL_ALL_SIGNAL = "com.onesidegamer.intent.action.KILL_ALL_SIGNAL";
