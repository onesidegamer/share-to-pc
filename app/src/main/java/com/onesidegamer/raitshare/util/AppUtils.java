...
import com.onesidegamer.raitshare.App;
import com.onesidegamer.raitshare.BuildConfig;
import com.onesidegamer.raitshare.R;
import com.onesidegamer.raitshare.activity.WebShareActivity;
...
public class AppUtils
{
    ...
    public static DocumentFile createLog(Context context)
    {
        ...
        String fileName = FileUtils.getUniqueFileName(saveDirectory, "raitshare_log.txt", true);
